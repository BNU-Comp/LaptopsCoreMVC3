...
namespace LaptopsCoreMVC.Controllers
{
    ...
    public class LaptopsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LaptopID,Price,RamSize,MemorySize,LaptopDimensions,OperatingSystem,Model,Resolution,Processor,BatteryLife,Colour,Description")] Laptop laptop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LaptopID,Price,RamSize,MemorySize,LaptopDimensions,OperatingSystem,Model,Resolution,Processor,BatteryLife,Colour,Description")] Laptop laptop)
        {
